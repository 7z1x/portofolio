            ...
            <div className="hero-text-container">
              ...
              <div className="hero-actions-row">
                ...
                <div className="hero-socials">
                  <a href="https://instagram.com/llzf4_" target="_blank" rel="noopener noreferrer" className="social-icon social-ig" aria-label="Instagram">
                  ...
                  <a href="https://github.com/7z1x" target="_blank" rel="noopener noreferrer" className="social-icon social-gh" aria-label="GitHub">
                  ...
                  <a href="https://www.linkedin.com/in/zulfahmi-m-ardianto/" target="_blank" rel="noopener noreferrer" className="social-icon social-li" aria-label="LinkedIn">
